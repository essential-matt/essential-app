...
final class FeedLocalizationTests: XCTestCase {
    func test_localizedStrings_haveKeysAndValuesForAllSupportedLocalizations() {
        ...
        let localizationBundles = allLocalizationBundles(in: presentationBundle, table: table)
        let localizedStringKeys = allLocalizedStringKeys(in: localizationBundles, table: table)

        localizationBundles
            .forEach { (bundle, localization) in
                localizedStringKeys
                    .forEach { key in
...
private func allLocalizationBundles(in bundle: Bundle, table: String, file: StaticString = #filePath, line: UInt = #line) -> [LocalizedBundle] {
    bundle
        .localizations
